...
const createOfferedCourseIntoDB = async (payload: TOfferedCourse) => {
  ...
  // check if the same offered course, same section, in same registered semester exists or not
  ...
  // get the schedules of faculties from database
  ...
  // get schedule from postman
  const newSchedule = {
    days,
    startTime,
    endTime,
  };
  // check time conflict of faculty when a new course offer
...
const updateOfferedCourseIntoDB = async (
  ...
  // check if the offered course exists on OfferedCourse model
  ...
  // check if the faculty exists in faculty model
  const isFacultyExists = await Faculty.findById(faculty);
  ...
  // check if the semester registration status is upcoming in semester registration model
